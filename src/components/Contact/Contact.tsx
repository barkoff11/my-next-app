...
const Contact = () => {
    ...
    return (
        <div className={styles.container}>
                    ...
                    <div className={styles.text}>Исследовательсткое агентство «Элементор»</div>
                        <div className={styles.contentList}>
                            <a className={styles.content}>
                                <svg>
                                    <use xlinkHref={`/img/sprite.svg#contacts__info--adress`}></use>
                                </svg>
                                125047, г. Москва, ул. Профсоюзная, д. 10 стр. 1
                            </a>
                            <a className={styles.content}>
                                <svg>
                                    <use xlinkHref={`/img/sprite.svg#contacts__info--mail`}></use>
                                </svg>
                                +7 (495) 325 45 54<br/> 
                            ...
                            <a className={styles.content}>
                                <svg>
                                    <use xlinkHref={`/img/sprite.svg#contacts__info--phone`}></use>
                                </svg>
            ...
            <img className={styles.image} src={`/img/contacts__map.jpg`} />
        </div>
    );
};
